...
{
    ros::init(argc, argv, "joint_position_command_interface");
    ros::NodeHandle nh;
    joint_group_positions.data.resize(12);
    joint_group_positions.data[0] = 0.5;
    joint_group_positions.data[1] = 1.8;
    joint_group_positions.data[2] = -2.7;
    joint_group_positions.data[3] = -0.5;
    joint_group_positions.data[4] = 1.8;
    joint_group_positions.data[5] = -2.7;
    joint_group_positions.data[6] = -0.5;
    joint_group_positions.data[7] = 1.8;
    joint_group_positions.data[8] = -2.7;
    joint_group_positions.data[9] = 0.5;
    joint_group_positions.data[10] = 1.8;
    joint_group_positions.data[11] = -2.7;
...
//            joint12ControllerCommandPub.publish(joint12);
            std::cout<<joint_group_positions<<std::endl;
