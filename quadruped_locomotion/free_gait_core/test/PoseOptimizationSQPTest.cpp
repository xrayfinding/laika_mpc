...
//  adapter.setInternalDataFromState(state);
  ...
  nominalStance[LimbEnum::LF_LEG] = Position(0.21935, 0.12, -0.37);
  nominalStance[LimbEnum::RF_LEG] = Position(0.21935, -0.12, -0.37);
  nominalStance[LimbEnum::LH_LEG] = Position(-0.21935, 0.12, -0.37);
  nominalStance[LimbEnum::RH_LEG] = Position(-0.21935, -0.12, -0.37);
  objective.setNominalStance(nominalStance);
  Stance currentStance;
  currentStance[LimbEnum::LF_LEG] = Position(0.21935, 0.12, 0.0);
  currentStance[LimbEnum::RF_LEG] = Position(0.21935, -0.12, 0.0);
  currentStance[LimbEnum::LH_LEG] = Position(-0.21935, 0.12, 0.0);
  currentStance[LimbEnum::RH_LEG] = Position(-0.21935, -0.12, 0.0);
...
TEST(PoseOptimizationSQP, OptimizationSquareUp)
{
  ...
  optimization.setNominalStance(Stance({
    {LimbEnum::LF_LEG, Position(0.21935, 0.12, -0.37)},
    {LimbEnum::RF_LEG, Position(0.21935, -0.12, -0.37)},
    {LimbEnum::LH_LEG, Position(-0.21935, 0.12, -0.37)},
    {LimbEnum::RH_LEG, Position(-0.21935, -0.12, -0.37)} }));

  Stance stance;
  stance[LimbEnum::LF_LEG] = Position(0.21935, 0.12, -0.1);
  stance[LimbEnum::RF_LEG] = Position(0.21935, -0.12, -0.1);
  stance[LimbEnum::LH_LEG] = Position(-0.21935, 0.12, -0.1);
  stance[LimbEnum::RH_LEG] = Position(-0.21935, -0.12, -0.1);
