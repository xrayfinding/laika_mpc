...
/**
 * @brief StepCompleter::complete, set legMotion and baseMotion parameters according to a given step
 * @param state
 * @param queue
 * @param step
 * @return
...
/**
 * @brief StepCompleter::complete, set a baseMotion
 * @param state
 * @param step
 * @param queue
 * @param baseMotion
 * @return true if baseMotion is seted
 */
