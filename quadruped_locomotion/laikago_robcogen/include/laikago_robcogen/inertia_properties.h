#ifndef RCG_LAIKAGO_INERTIA_PROPERTIES_H_
#define RCG_LAIKAGO_INERTIA_PROPERTIES_H_
...
class InertiaProperties {
    public:
        ...
        /*!
         * Fresh values for the runtime parameters of the robot laikago,
...
inline Scalar InertiaProperties::getTotalMass() const {
    return m_base + m_RF_HIP + m_RF_THIGH + m_RF_SHANK + m_LF_HIP + m_LF_THIGH + m_LF_SHANK + m_RH_HIP + m_RH_THIGH + m_RH_SHANK + m_LH_HIP + m_LH_THIGH + m_LH_SHANK;
}
