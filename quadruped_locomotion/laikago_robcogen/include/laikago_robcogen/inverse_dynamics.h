#ifndef RCG_LAIKAGO_INVERSE_DYNAMICS_H_
#define RCG_LAIKAGO_INVERSE_DYNAMICS_H_
...
/**
 * The Inverse Dynamics routine for the robot laikago.
 *
...
public:
     ...
     *     the robot laikago, which will be used by this instance
