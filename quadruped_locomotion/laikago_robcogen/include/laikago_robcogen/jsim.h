#ifndef RCG_LAIKAGO_JSIM_H_
#define RCG_LAIKAGO_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot laikago.
 */
class JSIM : public iit::rbd::StateDependentMatrix<laikago::rcg::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<laikago::rcg::JointState, 18, 18, JSIM> Base;
    public:
