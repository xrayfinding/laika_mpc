...
laikago::rcg::InertiaProperties::InertiaProperties()
{
    ...
    tensor_RF_SHANK.fill(
        m_RF_SHANK,
        com_RF_SHANK,
        Utils::buildInertiaTensor<Scalar>(ix_RF_SHANK,iy_RF_SHANK,iz_RF_SHANK,ixy_RF_SHANK,ixz_RF_SHANK,0.0) );
    ...
    tensor_LF_SHANK.fill(
        m_LF_SHANK,
        com_LF_SHANK,
        Utils::buildInertiaTensor<Scalar>(ix_LF_SHANK,iy_LF_SHANK,iz_LF_SHANK,ixy_LF_SHANK,ixz_LF_SHANK,0.0) );
    ...
    tensor_RH_SHANK.fill(
        m_RH_SHANK,
        com_RH_SHANK,
        Utils::buildInertiaTensor<Scalar>(ix_RH_SHANK,iy_RH_SHANK,iz_RH_SHANK,ixy_RH_SHANK,ixz_RH_SHANK,0.0) );
    ...
    tensor_LH_SHANK.fill(
        m_LH_SHANK,
        com_LH_SHANK,
        Utils::buildInertiaTensor<Scalar>(ix_LH_SHANK,iy_LH_SHANK,iz_LH_SHANK,ixy_LH_SHANK,ixz_LH_SHANK,0.0) );

}


void laikago::rcg::InertiaProperties::updateParameters(const RuntimeInertiaParams& fresh)
{
    this-> params = fresh;
}
