...
const MotionTransforms::Type_fr_base_X_LF_FOOT& MotionTransforms::Type_fr_base_X_LF_FOOT::update(const state_t& q)
{
    ...
    (*this)(3,0) = ((- ty_LF_HFE-( ty_LF_HAA * cos_q_LF_HAA)) * cos_q_LF_HFE * sin_q_LF_KFE)+((- ty_LF_HFE-( ty_LF_HAA * cos_q_LF_HAA)) * sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(3,1) = (- tx_LF_FOOT * sin_q_LF_HFE * sin_q_LF_KFE)+( tx_LF_FOOT * cos_q_LF_HFE * cos_q_LF_KFE)+( tx_LF_KFE * cos_q_LF_HFE)+( ty_LF_HAA * sin_q_LF_HAA);
    (*this)(3,2) = ((- ty_LF_HFE-( ty_LF_HAA * cos_q_LF_HAA)) * sin_q_LF_HFE * sin_q_LF_KFE)+(( ty_LF_HFE+( ty_LF_HAA * cos_q_LF_HAA)) * cos_q_LF_HFE * cos_q_LF_KFE);
    (*this)(3,3) = (cos_q_LF_HFE * cos_q_LF_KFE)-(sin_q_LF_HFE * sin_q_LF_KFE);
    (*this)(3,5) = (cos_q_LF_HFE * sin_q_LF_KFE)+(sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(4,0) = ((( tx_LF_HAA * cos_q_LF_HAA * cos_q_LF_HFE)-( ty_LF_HFE * sin_q_LF_HAA * sin_q_LF_HFE)) * sin_q_LF_KFE)+(((- tx_LF_KFE * cos_q_LF_HAA)+( ty_LF_HFE * sin_q_LF_HAA * cos_q_LF_HFE)+( tx_LF_HAA * cos_q_LF_HAA * sin_q_LF_HFE)) * cos_q_LF_KFE)-( tx_LF_FOOT * cos_q_LF_HAA);
    ...
    (*this)(4,2) = (((- tx_LF_KFE * cos_q_LF_HAA)+( ty_LF_HFE * sin_q_LF_HAA * cos_q_LF_HFE)+( tx_LF_HAA * cos_q_LF_HAA * sin_q_LF_HFE)) * sin_q_LF_KFE)+((( ty_LF_HFE * sin_q_LF_HAA * sin_q_LF_HFE)-( tx_LF_HAA * cos_q_LF_HAA * cos_q_LF_HFE)) * cos_q_LF_KFE);
    ...
    (*this)(5,0) = ((( tx_LF_HAA * sin_q_LF_HAA * cos_q_LF_HFE)+((( ty_LF_HFE * cos_q_LF_HAA)+ ty_LF_HAA) * sin_q_LF_HFE)) * sin_q_LF_KFE)+(((- tx_LF_KFE * sin_q_LF_HAA)+(((- ty_LF_HFE * cos_q_LF_HAA)- ty_LF_HAA) * cos_q_LF_HFE)+( tx_LF_HAA * sin_q_LF_HAA * sin_q_LF_HFE)) * cos_q_LF_KFE)-( tx_LF_FOOT * sin_q_LF_HAA);
    ...
    (*this)(5,2) = (((- tx_LF_KFE * sin_q_LF_HAA)+(((- ty_LF_HFE * cos_q_LF_HAA)- ty_LF_HAA) * cos_q_LF_HFE)+( tx_LF_HAA * sin_q_LF_HAA * sin_q_LF_HFE)) * sin_q_LF_KFE)+(((((- ty_LF_HFE * cos_q_LF_HAA)- ty_LF_HAA) * sin_q_LF_HFE)-( tx_LF_HAA * sin_q_LF_HAA * cos_q_LF_HFE)) * cos_q_LF_KFE);
...
const MotionTransforms::Type_fr_base_X_RF_FOOT& MotionTransforms::Type_fr_base_X_RF_FOOT::update(const state_t& q)
{
    ...
    (*this)(3,0) = ((- ty_RF_HFE-( ty_RF_HAA * cos_q_RF_HAA)) * cos_q_RF_HFE * sin_q_RF_KFE)+((- ty_RF_HFE-( ty_RF_HAA * cos_q_RF_HAA)) * sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(3,1) = (- tx_RF_FOOT * sin_q_RF_HFE * sin_q_RF_KFE)+( tx_RF_FOOT * cos_q_RF_HFE * cos_q_RF_KFE)+( tx_RF_KFE * cos_q_RF_HFE)+( ty_RF_HAA * sin_q_RF_HAA);
    (*this)(3,2) = ((- ty_RF_HFE-( ty_RF_HAA * cos_q_RF_HAA)) * sin_q_RF_HFE * sin_q_RF_KFE)+(( ty_RF_HFE+( ty_RF_HAA * cos_q_RF_HAA)) * cos_q_RF_HFE * cos_q_RF_KFE);
    (*this)(3,3) = (cos_q_RF_HFE * cos_q_RF_KFE)-(sin_q_RF_HFE * sin_q_RF_KFE);
    (*this)(3,5) = (cos_q_RF_HFE * sin_q_RF_KFE)+(sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(4,0) = ((( tx_RF_HAA * cos_q_RF_HAA * cos_q_RF_HFE)-( ty_RF_HFE * sin_q_RF_HAA * sin_q_RF_HFE)) * sin_q_RF_KFE)+(((- tx_RF_KFE * cos_q_RF_HAA)+( ty_RF_HFE * sin_q_RF_HAA * cos_q_RF_HFE)+( tx_RF_HAA * cos_q_RF_HAA * sin_q_RF_HFE)) * cos_q_RF_KFE)-( tx_RF_FOOT * cos_q_RF_HAA);
    ...
    (*this)(4,2) = (((- tx_RF_KFE * cos_q_RF_HAA)+( ty_RF_HFE * sin_q_RF_HAA * cos_q_RF_HFE)+( tx_RF_HAA * cos_q_RF_HAA * sin_q_RF_HFE)) * sin_q_RF_KFE)+((( ty_RF_HFE * sin_q_RF_HAA * sin_q_RF_HFE)-( tx_RF_HAA * cos_q_RF_HAA * cos_q_RF_HFE)) * cos_q_RF_KFE);
    ...
    (*this)(5,0) = ((( tx_RF_HAA * sin_q_RF_HAA * cos_q_RF_HFE)+((( ty_RF_HFE * cos_q_RF_HAA)+ ty_RF_HAA) * sin_q_RF_HFE)) * sin_q_RF_KFE)+(((- tx_RF_KFE * sin_q_RF_HAA)+(((- ty_RF_HFE * cos_q_RF_HAA)- ty_RF_HAA) * cos_q_RF_HFE)+( tx_RF_HAA * sin_q_RF_HAA * sin_q_RF_HFE)) * cos_q_RF_KFE)-( tx_RF_FOOT * sin_q_RF_HAA);
    ...
    (*this)(5,2) = (((- tx_RF_KFE * sin_q_RF_HAA)+(((- ty_RF_HFE * cos_q_RF_HAA)- ty_RF_HAA) * cos_q_RF_HFE)+( tx_RF_HAA * sin_q_RF_HAA * sin_q_RF_HFE)) * sin_q_RF_KFE)+(((((- ty_RF_HFE * cos_q_RF_HAA)- ty_RF_HAA) * sin_q_RF_HFE)-( tx_RF_HAA * sin_q_RF_HAA * cos_q_RF_HFE)) * cos_q_RF_KFE);
...
const MotionTransforms::Type_fr_base_X_LH_FOOT& MotionTransforms::Type_fr_base_X_LH_FOOT::update(const state_t& q)
{
    ...
    (*this)(3,0) = ((- ty_LH_HFE-( ty_LH_HAA * cos_q_LH_HAA)) * cos_q_LH_HFE * sin_q_LH_KFE)+((- ty_LH_HFE-( ty_LH_HAA * cos_q_LH_HAA)) * sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(3,1) = (- tx_LH_FOOT * sin_q_LH_HFE * sin_q_LH_KFE)+( tx_LH_FOOT * cos_q_LH_HFE * cos_q_LH_KFE)+( tx_LH_KFE * cos_q_LH_HFE)+( ty_LH_HAA * sin_q_LH_HAA);
    (*this)(3,2) = ((- ty_LH_HFE-( ty_LH_HAA * cos_q_LH_HAA)) * sin_q_LH_HFE * sin_q_LH_KFE)+(( ty_LH_HFE+( ty_LH_HAA * cos_q_LH_HAA)) * cos_q_LH_HFE * cos_q_LH_KFE);
    (*this)(3,3) = (cos_q_LH_HFE * cos_q_LH_KFE)-(sin_q_LH_HFE * sin_q_LH_KFE);
    (*this)(3,5) = (cos_q_LH_HFE * sin_q_LH_KFE)+(sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(4,0) = ((( tx_LH_HAA * cos_q_LH_HAA * cos_q_LH_HFE)-( ty_LH_HFE * sin_q_LH_HAA * sin_q_LH_HFE)) * sin_q_LH_KFE)+(((- tx_LH_KFE * cos_q_LH_HAA)+( ty_LH_HFE * sin_q_LH_HAA * cos_q_LH_HFE)+( tx_LH_HAA * cos_q_LH_HAA * sin_q_LH_HFE)) * cos_q_LH_KFE)-( tx_LH_FOOT * cos_q_LH_HAA);
    ...
    (*this)(4,2) = (((- tx_LH_KFE * cos_q_LH_HAA)+( ty_LH_HFE * sin_q_LH_HAA * cos_q_LH_HFE)+( tx_LH_HAA * cos_q_LH_HAA * sin_q_LH_HFE)) * sin_q_LH_KFE)+((( ty_LH_HFE * sin_q_LH_HAA * sin_q_LH_HFE)-( tx_LH_HAA * cos_q_LH_HAA * cos_q_LH_HFE)) * cos_q_LH_KFE);
    ...
    (*this)(5,0) = ((( tx_LH_HAA * sin_q_LH_HAA * cos_q_LH_HFE)+((( ty_LH_HFE * cos_q_LH_HAA)+ ty_LH_HAA) * sin_q_LH_HFE)) * sin_q_LH_KFE)+(((- tx_LH_KFE * sin_q_LH_HAA)+(((- ty_LH_HFE * cos_q_LH_HAA)- ty_LH_HAA) * cos_q_LH_HFE)+( tx_LH_HAA * sin_q_LH_HAA * sin_q_LH_HFE)) * cos_q_LH_KFE)-( tx_LH_FOOT * sin_q_LH_HAA);
    ...
    (*this)(5,2) = (((- tx_LH_KFE * sin_q_LH_HAA)+(((- ty_LH_HFE * cos_q_LH_HAA)- ty_LH_HAA) * cos_q_LH_HFE)+( tx_LH_HAA * sin_q_LH_HAA * sin_q_LH_HFE)) * sin_q_LH_KFE)+(((((- ty_LH_HFE * cos_q_LH_HAA)- ty_LH_HAA) * sin_q_LH_HFE)-( tx_LH_HAA * sin_q_LH_HAA * cos_q_LH_HFE)) * cos_q_LH_KFE);
...
const MotionTransforms::Type_fr_base_X_RH_FOOT& MotionTransforms::Type_fr_base_X_RH_FOOT::update(const state_t& q)
{
    ...
    (*this)(3,0) = ((- ty_RH_HFE-( ty_RH_HAA * cos_q_RH_HAA)) * cos_q_RH_HFE * sin_q_RH_KFE)+((- ty_RH_HFE-( ty_RH_HAA * cos_q_RH_HAA)) * sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(3,1) = (- tx_RH_FOOT * sin_q_RH_HFE * sin_q_RH_KFE)+( tx_RH_FOOT * cos_q_RH_HFE * cos_q_RH_KFE)+( tx_RH_KFE * cos_q_RH_HFE)+( ty_RH_HAA * sin_q_RH_HAA);
    (*this)(3,2) = ((- ty_RH_HFE-( ty_RH_HAA * cos_q_RH_HAA)) * sin_q_RH_HFE * sin_q_RH_KFE)+(( ty_RH_HFE+( ty_RH_HAA * cos_q_RH_HAA)) * cos_q_RH_HFE * cos_q_RH_KFE);
    (*this)(3,3) = (cos_q_RH_HFE * cos_q_RH_KFE)-(sin_q_RH_HFE * sin_q_RH_KFE);
    (*this)(3,5) = (cos_q_RH_HFE * sin_q_RH_KFE)+(sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(4,0) = ((( tx_RH_HAA * cos_q_RH_HAA * cos_q_RH_HFE)-( ty_RH_HFE * sin_q_RH_HAA * sin_q_RH_HFE)) * sin_q_RH_KFE)+(((- tx_RH_KFE * cos_q_RH_HAA)+( ty_RH_HFE * sin_q_RH_HAA * cos_q_RH_HFE)+( tx_RH_HAA * cos_q_RH_HAA * sin_q_RH_HFE)) * cos_q_RH_KFE)-( tx_RH_FOOT * cos_q_RH_HAA);
    ...
    (*this)(4,2) = (((- tx_RH_KFE * cos_q_RH_HAA)+( ty_RH_HFE * sin_q_RH_HAA * cos_q_RH_HFE)+( tx_RH_HAA * cos_q_RH_HAA * sin_q_RH_HFE)) * sin_q_RH_KFE)+((( ty_RH_HFE * sin_q_RH_HAA * sin_q_RH_HFE)-( tx_RH_HAA * cos_q_RH_HAA * cos_q_RH_HFE)) * cos_q_RH_KFE);
    ...
    (*this)(5,0) = ((( tx_RH_HAA * sin_q_RH_HAA * cos_q_RH_HFE)+((( ty_RH_HFE * cos_q_RH_HAA)+ ty_RH_HAA) * sin_q_RH_HFE)) * sin_q_RH_KFE)+(((- tx_RH_KFE * sin_q_RH_HAA)+(((- ty_RH_HFE * cos_q_RH_HAA)- ty_RH_HAA) * cos_q_RH_HFE)+( tx_RH_HAA * sin_q_RH_HAA * sin_q_RH_HFE)) * cos_q_RH_KFE)-( tx_RH_FOOT * sin_q_RH_HAA);
    ...
    (*this)(5,2) = (((- tx_RH_KFE * sin_q_RH_HAA)+(((- ty_RH_HFE * cos_q_RH_HAA)- ty_RH_HAA) * cos_q_RH_HFE)+( tx_RH_HAA * sin_q_RH_HAA * sin_q_RH_HFE)) * sin_q_RH_KFE)+(((((- ty_RH_HFE * cos_q_RH_HAA)- ty_RH_HAA) * sin_q_RH_HFE)-( tx_RH_HAA * sin_q_RH_HAA * cos_q_RH_HFE)) * cos_q_RH_KFE);
...
const MotionTransforms::Type_fr_base_X_fr_LF_KFE& MotionTransforms::Type_fr_base_X_fr_LF_KFE::update(const state_t& q)
{
    ...
    (*this)(2,2) = sin_q_LF_HAA;
    (*this)(3,0) = ((- ty_LF_HAA * cos_q_LF_HAA)- ty_LF_HFE) * cos_q_LF_HFE;
    (*this)(3,1) = (( ty_LF_HAA * cos_q_LF_HAA)+ ty_LF_HFE) * sin_q_LF_HFE;
    (*this)(3,2) = ( tx_LF_KFE * cos_q_LF_HFE)+( ty_LF_HAA * sin_q_LF_HAA);
    (*this)(3,3) = -sin_q_LF_HFE;
    (*this)(3,4) = -cos_q_LF_HFE;
    (*this)(4,0) = ( tx_LF_HAA * cos_q_LF_HAA * cos_q_LF_HFE)-( ty_LF_HFE * sin_q_LF_HAA * sin_q_LF_HFE);
    (*this)(4,1) = (- tx_LF_HAA * cos_q_LF_HAA * sin_q_LF_HFE)-( ty_LF_HFE * sin_q_LF_HAA * cos_q_LF_HFE)+( tx_LF_KFE * cos_q_LF_HAA);
    (*this)(4,2) = ( tx_LF_KFE * sin_q_LF_HAA * sin_q_LF_HFE)-( tx_LF_HAA * sin_q_LF_HAA);
    (*this)(4,3) = sin_q_LF_HAA * cos_q_LF_HFE;
    (*this)(4,4) = -sin_q_LF_HAA * sin_q_LF_HFE;
    (*this)(4,5) = cos_q_LF_HAA;
    (*this)(5,0) = (( ty_LF_HAA+( ty_LF_HFE * cos_q_LF_HAA)) * sin_q_LF_HFE)+( tx_LF_HAA * sin_q_LF_HAA * cos_q_LF_HFE);
    (*this)(5,1) = (- tx_LF_HAA * sin_q_LF_HAA * sin_q_LF_HFE)+(( ty_LF_HAA+( ty_LF_HFE * cos_q_LF_HAA)) * cos_q_LF_HFE)+( tx_LF_KFE * sin_q_LF_HAA);
...
const MotionTransforms::Type_fr_base_X_fr_RF_KFE& MotionTransforms::Type_fr_base_X_fr_RF_KFE::update(const state_t& q)
{
    ...
    (*this)(2,2) = sin_q_RF_HAA;
    (*this)(3,0) = ((- ty_RF_HAA * cos_q_RF_HAA)- ty_RF_HFE) * cos_q_RF_HFE;
    (*this)(3,1) = (( ty_RF_HAA * cos_q_RF_HAA)+ ty_RF_HFE) * sin_q_RF_HFE;
    (*this)(3,2) = ( tx_RF_KFE * cos_q_RF_HFE)+( ty_RF_HAA * sin_q_RF_HAA);
    (*this)(3,3) = -sin_q_RF_HFE;
    (*this)(3,4) = -cos_q_RF_HFE;
    (*this)(4,0) = ( tx_RF_HAA * cos_q_RF_HAA * cos_q_RF_HFE)-( ty_RF_HFE * sin_q_RF_HAA * sin_q_RF_HFE);
    (*this)(4,1) = (- tx_RF_HAA * cos_q_RF_HAA * sin_q_RF_HFE)-( ty_RF_HFE * sin_q_RF_HAA * cos_q_RF_HFE)+( tx_RF_KFE * cos_q_RF_HAA);
    ...
    (*this)(4,5) = cos_q_RF_HAA;
    (*this)(5,0) = (( ty_RF_HAA+( ty_RF_HFE * cos_q_RF_HAA)) * sin_q_RF_HFE)+( tx_RF_HAA * sin_q_RF_HAA * cos_q_RF_HFE);
    (*this)(5,1) = (- tx_RF_HAA * sin_q_RF_HAA * sin_q_RF_HFE)+(( ty_RF_HAA+( ty_RF_HFE * cos_q_RF_HAA)) * cos_q_RF_HFE)+( tx_RF_KFE * sin_q_RF_HAA);
...
const MotionTransforms::Type_fr_base_X_fr_LH_KFE& MotionTransforms::Type_fr_base_X_fr_LH_KFE::update(const state_t& q)
{
    ...
    (*this)(2,2) = sin_q_LH_HAA;
    (*this)(3,0) = ((- ty_LH_HAA * cos_q_LH_HAA)- ty_LH_HFE) * cos_q_LH_HFE;
    (*this)(3,1) = (( ty_LH_HAA * cos_q_LH_HAA)+ ty_LH_HFE) * sin_q_LH_HFE;
    (*this)(3,2) = ( tx_LH_KFE * cos_q_LH_HFE)+( ty_LH_HAA * sin_q_LH_HAA);
    (*this)(3,3) = -sin_q_LH_HFE;
    (*this)(3,4) = -cos_q_LH_HFE;
    (*this)(4,0) = ( tx_LH_HAA * cos_q_LH_HAA * cos_q_LH_HFE)-( ty_LH_HFE * sin_q_LH_HAA * sin_q_LH_HFE);
    (*this)(4,1) = (- tx_LH_HAA * cos_q_LH_HAA * sin_q_LH_HFE)-( ty_LH_HFE * sin_q_LH_HAA * cos_q_LH_HFE)+( tx_LH_KFE * cos_q_LH_HAA);
    (*this)(4,2) = ( tx_LH_KFE * sin_q_LH_HAA * sin_q_LH_HFE)-( tx_LH_HAA * sin_q_LH_HAA);
    (*this)(4,3) = sin_q_LH_HAA * cos_q_LH_HFE;
    (*this)(4,4) = -sin_q_LH_HAA * sin_q_LH_HFE;
    (*this)(4,5) = cos_q_LH_HAA;
    (*this)(5,0) = (( ty_LH_HAA+( ty_LH_HFE * cos_q_LH_HAA)) * sin_q_LH_HFE)+( tx_LH_HAA * sin_q_LH_HAA * cos_q_LH_HFE);
    (*this)(5,1) = (- tx_LH_HAA * sin_q_LH_HAA * sin_q_LH_HFE)+(( ty_LH_HAA+( ty_LH_HFE * cos_q_LH_HAA)) * cos_q_LH_HFE)+( tx_LH_KFE * sin_q_LH_HAA);
...
const MotionTransforms::Type_fr_base_X_fr_RH_KFE& MotionTransforms::Type_fr_base_X_fr_RH_KFE::update(const state_t& q)
{
    ...
    (*this)(2,2) = sin_q_RH_HAA;
    (*this)(3,0) = ((- ty_RH_HAA * cos_q_RH_HAA)- ty_RH_HFE) * cos_q_RH_HFE;
    (*this)(3,1) = (( ty_RH_HAA * cos_q_RH_HAA)+ ty_RH_HFE) * sin_q_RH_HFE;
    (*this)(3,2) = ( tx_RH_KFE * cos_q_RH_HFE)+( ty_RH_HAA * sin_q_RH_HAA);
    (*this)(3,3) = -sin_q_RH_HFE;
    (*this)(3,4) = -cos_q_RH_HFE;
    (*this)(4,0) = ( tx_RH_HAA * cos_q_RH_HAA * cos_q_RH_HFE)-( ty_RH_HFE * sin_q_RH_HAA * sin_q_RH_HFE);
    (*this)(4,1) = (- tx_RH_HAA * cos_q_RH_HAA * sin_q_RH_HFE)-( ty_RH_HFE * sin_q_RH_HAA * cos_q_RH_HFE)+( tx_RH_KFE * cos_q_RH_HAA);
    ...
    (*this)(4,5) = cos_q_RH_HAA;
    (*this)(5,0) = (( ty_RH_HAA+( ty_RH_HFE * cos_q_RH_HAA)) * sin_q_RH_HFE)+( tx_RH_HAA * sin_q_RH_HAA * cos_q_RH_HFE);
    (*this)(5,1) = (- tx_RH_HAA * sin_q_RH_HAA * sin_q_RH_HFE)+(( ty_RH_HAA+( ty_RH_HFE * cos_q_RH_HAA)) * cos_q_RH_HFE)+( tx_RH_KFE * sin_q_RH_HAA);
...
const ForceTransforms::Type_fr_base_X_LF_FOOT& ForceTransforms::Type_fr_base_X_LF_FOOT::update(const state_t& q)
{
    ...
    (*this)(0,0) = (cos_q_LF_HFE * cos_q_LF_KFE)-(sin_q_LF_HFE * sin_q_LF_KFE);
    (*this)(0,2) = (cos_q_LF_HFE * sin_q_LF_KFE)+(sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(0,3) = ((- ty_LF_HFE-( ty_LF_HAA * cos_q_LF_HAA)) * cos_q_LF_HFE * sin_q_LF_KFE)+((- ty_LF_HFE-( ty_LF_HAA * cos_q_LF_HAA)) * sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(0,4) = (- tx_LF_FOOT * sin_q_LF_HFE * sin_q_LF_KFE)+( tx_LF_FOOT * cos_q_LF_HFE * cos_q_LF_KFE)+( tx_LF_KFE * cos_q_LF_HFE)+( ty_LF_HAA * sin_q_LF_HAA);
    (*this)(0,5) = ((- ty_LF_HFE-( ty_LF_HAA * cos_q_LF_HAA)) * sin_q_LF_HFE * sin_q_LF_KFE)+(( ty_LF_HFE+( ty_LF_HAA * cos_q_LF_HAA)) * cos_q_LF_HFE * cos_q_LF_KFE);
    (*this)(1,0) = (sin_q_LF_HAA * cos_q_LF_HFE * sin_q_LF_KFE)+(sin_q_LF_HAA * sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(1,1) = cos_q_LF_HAA;
    (*this)(1,2) = (sin_q_LF_HAA * sin_q_LF_HFE * sin_q_LF_KFE)-(sin_q_LF_HAA * cos_q_LF_HFE * cos_q_LF_KFE);
    (*this)(1,3) = ((( tx_LF_HAA * cos_q_LF_HAA * cos_q_LF_HFE)-( ty_LF_HFE * sin_q_LF_HAA * sin_q_LF_HFE)) * sin_q_LF_KFE)+(((- tx_LF_KFE * cos_q_LF_HAA)+( ty_LF_HFE * sin_q_LF_HAA * cos_q_LF_HFE)+( tx_LF_HAA * cos_q_LF_HAA * sin_q_LF_HFE)) * cos_q_LF_KFE)-( tx_LF_FOOT * cos_q_LF_HAA);
    ...
    (*this)(1,5) = (((- tx_LF_KFE * cos_q_LF_HAA)+( ty_LF_HFE * sin_q_LF_HAA * cos_q_LF_HFE)+( tx_LF_HAA * cos_q_LF_HAA * sin_q_LF_HFE)) * sin_q_LF_KFE)+((( ty_LF_HFE * sin_q_LF_HAA * sin_q_LF_HFE)-( tx_LF_HAA * cos_q_LF_HAA * cos_q_LF_HFE)) * cos_q_LF_KFE);
    (*this)(2,0) = (-cos_q_LF_HAA * cos_q_LF_HFE * sin_q_LF_KFE)-(cos_q_LF_HAA * sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(2,1) = sin_q_LF_HAA;
    (*this)(2,2) = (cos_q_LF_HAA * cos_q_LF_HFE * cos_q_LF_KFE)-(cos_q_LF_HAA * sin_q_LF_HFE * sin_q_LF_KFE);
    (*this)(2,3) = ((( tx_LF_HAA * sin_q_LF_HAA * cos_q_LF_HFE)+((( ty_LF_HFE * cos_q_LF_HAA)+ ty_LF_HAA) * sin_q_LF_HFE)) * sin_q_LF_KFE)+(((- tx_LF_KFE * sin_q_LF_HAA)+(((- ty_LF_HFE * cos_q_LF_HAA)- ty_LF_HAA) * cos_q_LF_HFE)+( tx_LF_HAA * sin_q_LF_HAA * sin_q_LF_HFE)) * cos_q_LF_KFE)-( tx_LF_FOOT * sin_q_LF_HAA);
    ...
    (*this)(2,5) = (((- tx_LF_KFE * sin_q_LF_HAA)+(((- ty_LF_HFE * cos_q_LF_HAA)- ty_LF_HAA) * cos_q_LF_HFE)+( tx_LF_HAA * sin_q_LF_HAA * sin_q_LF_HFE)) * sin_q_LF_KFE)+(((((- ty_LF_HFE * cos_q_LF_HAA)- ty_LF_HAA) * sin_q_LF_HFE)-( tx_LF_HAA * sin_q_LF_HAA * cos_q_LF_HFE)) * cos_q_LF_KFE);
    (*this)(3,3) = (cos_q_LF_HFE * cos_q_LF_KFE)-(sin_q_LF_HFE * sin_q_LF_KFE);
    (*this)(3,5) = (cos_q_LF_HFE * sin_q_LF_KFE)+(sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(4,3) = (sin_q_LF_HAA * cos_q_LF_HFE * sin_q_LF_KFE)+(sin_q_LF_HAA * sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(4,4) = cos_q_LF_HAA;
...
const ForceTransforms::Type_fr_base_X_RF_FOOT& ForceTransforms::Type_fr_base_X_RF_FOOT::update(const state_t& q)
{
    ...
    (*this)(0,0) = (cos_q_RF_HFE * cos_q_RF_KFE)-(sin_q_RF_HFE * sin_q_RF_KFE);
    (*this)(0,2) = (cos_q_RF_HFE * sin_q_RF_KFE)+(sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(0,3) = ((- ty_RF_HFE-( ty_RF_HAA * cos_q_RF_HAA)) * cos_q_RF_HFE * sin_q_RF_KFE)+((- ty_RF_HFE-( ty_RF_HAA * cos_q_RF_HAA)) * sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(0,4) = (- tx_RF_FOOT * sin_q_RF_HFE * sin_q_RF_KFE)+( tx_RF_FOOT * cos_q_RF_HFE * cos_q_RF_KFE)+( tx_RF_KFE * cos_q_RF_HFE)+( ty_RF_HAA * sin_q_RF_HAA);
    (*this)(0,5) = ((- ty_RF_HFE-( ty_RF_HAA * cos_q_RF_HAA)) * sin_q_RF_HFE * sin_q_RF_KFE)+(( ty_RF_HFE+( ty_RF_HAA * cos_q_RF_HAA)) * cos_q_RF_HFE * cos_q_RF_KFE);
    (*this)(1,0) = (sin_q_RF_HAA * cos_q_RF_HFE * sin_q_RF_KFE)+(sin_q_RF_HAA * sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(1,1) = cos_q_RF_HAA;
    (*this)(1,2) = (sin_q_RF_HAA * sin_q_RF_HFE * sin_q_RF_KFE)-(sin_q_RF_HAA * cos_q_RF_HFE * cos_q_RF_KFE);
    (*this)(1,3) = ((( tx_RF_HAA * cos_q_RF_HAA * cos_q_RF_HFE)-( ty_RF_HFE * sin_q_RF_HAA * sin_q_RF_HFE)) * sin_q_RF_KFE)+(((- tx_RF_KFE * cos_q_RF_HAA)+( ty_RF_HFE * sin_q_RF_HAA * cos_q_RF_HFE)+( tx_RF_HAA * cos_q_RF_HAA * sin_q_RF_HFE)) * cos_q_RF_KFE)-( tx_RF_FOOT * cos_q_RF_HAA);
    ...
    (*this)(1,5) = (((- tx_RF_KFE * cos_q_RF_HAA)+( ty_RF_HFE * sin_q_RF_HAA * cos_q_RF_HFE)+( tx_RF_HAA * cos_q_RF_HAA * sin_q_RF_HFE)) * sin_q_RF_KFE)+((( ty_RF_HFE * sin_q_RF_HAA * sin_q_RF_HFE)-( tx_RF_HAA * cos_q_RF_HAA * cos_q_RF_HFE)) * cos_q_RF_KFE);
    (*this)(2,0) = (-cos_q_RF_HAA * cos_q_RF_HFE * sin_q_RF_KFE)-(cos_q_RF_HAA * sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(2,1) = sin_q_RF_HAA;
    (*this)(2,2) = (cos_q_RF_HAA * cos_q_RF_HFE * cos_q_RF_KFE)-(cos_q_RF_HAA * sin_q_RF_HFE * sin_q_RF_KFE);
    (*this)(2,3) = ((( tx_RF_HAA * sin_q_RF_HAA * cos_q_RF_HFE)+((( ty_RF_HFE * cos_q_RF_HAA)+ ty_RF_HAA) * sin_q_RF_HFE)) * sin_q_RF_KFE)+(((- tx_RF_KFE * sin_q_RF_HAA)+(((- ty_RF_HFE * cos_q_RF_HAA)- ty_RF_HAA) * cos_q_RF_HFE)+( tx_RF_HAA * sin_q_RF_HAA * sin_q_RF_HFE)) * cos_q_RF_KFE)-( tx_RF_FOOT * sin_q_RF_HAA);
    ...
    (*this)(2,5) = (((- tx_RF_KFE * sin_q_RF_HAA)+(((- ty_RF_HFE * cos_q_RF_HAA)- ty_RF_HAA) * cos_q_RF_HFE)+( tx_RF_HAA * sin_q_RF_HAA * sin_q_RF_HFE)) * sin_q_RF_KFE)+(((((- ty_RF_HFE * cos_q_RF_HAA)- ty_RF_HAA) * sin_q_RF_HFE)-( tx_RF_HAA * sin_q_RF_HAA * cos_q_RF_HFE)) * cos_q_RF_KFE);
    (*this)(3,3) = (cos_q_RF_HFE * cos_q_RF_KFE)-(sin_q_RF_HFE * sin_q_RF_KFE);
    (*this)(3,5) = (cos_q_RF_HFE * sin_q_RF_KFE)+(sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(4,3) = (sin_q_RF_HAA * cos_q_RF_HFE * sin_q_RF_KFE)+(sin_q_RF_HAA * sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(4,4) = cos_q_RF_HAA;
...
const ForceTransforms::Type_fr_base_X_LH_FOOT& ForceTransforms::Type_fr_base_X_LH_FOOT::update(const state_t& q)
{
    ...
    (*this)(0,0) = (cos_q_LH_HFE * cos_q_LH_KFE)-(sin_q_LH_HFE * sin_q_LH_KFE);
    (*this)(0,2) = (cos_q_LH_HFE * sin_q_LH_KFE)+(sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(0,3) = ((- ty_LH_HFE-( ty_LH_HAA * cos_q_LH_HAA)) * cos_q_LH_HFE * sin_q_LH_KFE)+((- ty_LH_HFE-( ty_LH_HAA * cos_q_LH_HAA)) * sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(0,4) = (- tx_LH_FOOT * sin_q_LH_HFE * sin_q_LH_KFE)+( tx_LH_FOOT * cos_q_LH_HFE * cos_q_LH_KFE)+( tx_LH_KFE * cos_q_LH_HFE)+( ty_LH_HAA * sin_q_LH_HAA);
    (*this)(0,5) = ((- ty_LH_HFE-( ty_LH_HAA * cos_q_LH_HAA)) * sin_q_LH_HFE * sin_q_LH_KFE)+(( ty_LH_HFE+( ty_LH_HAA * cos_q_LH_HAA)) * cos_q_LH_HFE * cos_q_LH_KFE);
    (*this)(1,0) = (sin_q_LH_HAA * cos_q_LH_HFE * sin_q_LH_KFE)+(sin_q_LH_HAA * sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(1,1) = cos_q_LH_HAA;
    (*this)(1,2) = (sin_q_LH_HAA * sin_q_LH_HFE * sin_q_LH_KFE)-(sin_q_LH_HAA * cos_q_LH_HFE * cos_q_LH_KFE);
    (*this)(1,3) = ((( tx_LH_HAA * cos_q_LH_HAA * cos_q_LH_HFE)-( ty_LH_HFE * sin_q_LH_HAA * sin_q_LH_HFE)) * sin_q_LH_KFE)+(((- tx_LH_KFE * cos_q_LH_HAA)+( ty_LH_HFE * sin_q_LH_HAA * cos_q_LH_HFE)+( tx_LH_HAA * cos_q_LH_HAA * sin_q_LH_HFE)) * cos_q_LH_KFE)-( tx_LH_FOOT * cos_q_LH_HAA);
    ...
    (*this)(1,5) = (((- tx_LH_KFE * cos_q_LH_HAA)+( ty_LH_HFE * sin_q_LH_HAA * cos_q_LH_HFE)+( tx_LH_HAA * cos_q_LH_HAA * sin_q_LH_HFE)) * sin_q_LH_KFE)+((( ty_LH_HFE * sin_q_LH_HAA * sin_q_LH_HFE)-( tx_LH_HAA * cos_q_LH_HAA * cos_q_LH_HFE)) * cos_q_LH_KFE);
    (*this)(2,0) = (-cos_q_LH_HAA * cos_q_LH_HFE * sin_q_LH_KFE)-(cos_q_LH_HAA * sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(2,1) = sin_q_LH_HAA;
    (*this)(2,2) = (cos_q_LH_HAA * cos_q_LH_HFE * cos_q_LH_KFE)-(cos_q_LH_HAA * sin_q_LH_HFE * sin_q_LH_KFE);
    (*this)(2,3) = ((( tx_LH_HAA * sin_q_LH_HAA * cos_q_LH_HFE)+((( ty_LH_HFE * cos_q_LH_HAA)+ ty_LH_HAA) * sin_q_LH_HFE)) * sin_q_LH_KFE)+(((- tx_LH_KFE * sin_q_LH_HAA)+(((- ty_LH_HFE * cos_q_LH_HAA)- ty_LH_HAA) * cos_q_LH_HFE)+( tx_LH_HAA * sin_q_LH_HAA * sin_q_LH_HFE)) * cos_q_LH_KFE)-( tx_LH_FOOT * sin_q_LH_HAA);
    ...
    (*this)(2,5) = (((- tx_LH_KFE * sin_q_LH_HAA)+(((- ty_LH_HFE * cos_q_LH_HAA)- ty_LH_HAA) * cos_q_LH_HFE)+( tx_LH_HAA * sin_q_LH_HAA * sin_q_LH_HFE)) * sin_q_LH_KFE)+(((((- ty_LH_HFE * cos_q_LH_HAA)- ty_LH_HAA) * sin_q_LH_HFE)-( tx_LH_HAA * sin_q_LH_HAA * cos_q_LH_HFE)) * cos_q_LH_KFE);
    (*this)(3,3) = (cos_q_LH_HFE * cos_q_LH_KFE)-(sin_q_LH_HFE * sin_q_LH_KFE);
    (*this)(3,5) = (cos_q_LH_HFE * sin_q_LH_KFE)+(sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(4,3) = (sin_q_LH_HAA * cos_q_LH_HFE * sin_q_LH_KFE)+(sin_q_LH_HAA * sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(4,4) = cos_q_LH_HAA;
...
const ForceTransforms::Type_fr_base_X_RH_FOOT& ForceTransforms::Type_fr_base_X_RH_FOOT::update(const state_t& q)
{
    ...
    (*this)(0,0) = (cos_q_RH_HFE * cos_q_RH_KFE)-(sin_q_RH_HFE * sin_q_RH_KFE);
    (*this)(0,2) = (cos_q_RH_HFE * sin_q_RH_KFE)+(sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(0,3) = ((- ty_RH_HFE-( ty_RH_HAA * cos_q_RH_HAA)) * cos_q_RH_HFE * sin_q_RH_KFE)+((- ty_RH_HFE-( ty_RH_HAA * cos_q_RH_HAA)) * sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(0,4) = (- tx_RH_FOOT * sin_q_RH_HFE * sin_q_RH_KFE)+( tx_RH_FOOT * cos_q_RH_HFE * cos_q_RH_KFE)+( tx_RH_KFE * cos_q_RH_HFE)+( ty_RH_HAA * sin_q_RH_HAA);
    (*this)(0,5) = ((- ty_RH_HFE-( ty_RH_HAA * cos_q_RH_HAA)) * sin_q_RH_HFE * sin_q_RH_KFE)+(( ty_RH_HFE+( ty_RH_HAA * cos_q_RH_HAA)) * cos_q_RH_HFE * cos_q_RH_KFE);
    (*this)(1,0) = (sin_q_RH_HAA * cos_q_RH_HFE * sin_q_RH_KFE)+(sin_q_RH_HAA * sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(1,1) = cos_q_RH_HAA;
    (*this)(1,2) = (sin_q_RH_HAA * sin_q_RH_HFE * sin_q_RH_KFE)-(sin_q_RH_HAA * cos_q_RH_HFE * cos_q_RH_KFE);
    (*this)(1,3) = ((( tx_RH_HAA * cos_q_RH_HAA * cos_q_RH_HFE)-( ty_RH_HFE * sin_q_RH_HAA * sin_q_RH_HFE)) * sin_q_RH_KFE)+(((- tx_RH_KFE * cos_q_RH_HAA)+( ty_RH_HFE * sin_q_RH_HAA * cos_q_RH_HFE)+( tx_RH_HAA * cos_q_RH_HAA * sin_q_RH_HFE)) * cos_q_RH_KFE)-( tx_RH_FOOT * cos_q_RH_HAA);
    ...
    (*this)(1,5) = (((- tx_RH_KFE * cos_q_RH_HAA)+( ty_RH_HFE * sin_q_RH_HAA * cos_q_RH_HFE)+( tx_RH_HAA * cos_q_RH_HAA * sin_q_RH_HFE)) * sin_q_RH_KFE)+((( ty_RH_HFE * sin_q_RH_HAA * sin_q_RH_HFE)-( tx_RH_HAA * cos_q_RH_HAA * cos_q_RH_HFE)) * cos_q_RH_KFE);
    (*this)(2,0) = (-cos_q_RH_HAA * cos_q_RH_HFE * sin_q_RH_KFE)-(cos_q_RH_HAA * sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(2,1) = sin_q_RH_HAA;
    (*this)(2,2) = (cos_q_RH_HAA * cos_q_RH_HFE * cos_q_RH_KFE)-(cos_q_RH_HAA * sin_q_RH_HFE * sin_q_RH_KFE);
    (*this)(2,3) = ((( tx_RH_HAA * sin_q_RH_HAA * cos_q_RH_HFE)+((( ty_RH_HFE * cos_q_RH_HAA)+ ty_RH_HAA) * sin_q_RH_HFE)) * sin_q_RH_KFE)+(((- tx_RH_KFE * sin_q_RH_HAA)+(((- ty_RH_HFE * cos_q_RH_HAA)- ty_RH_HAA) * cos_q_RH_HFE)+( tx_RH_HAA * sin_q_RH_HAA * sin_q_RH_HFE)) * cos_q_RH_KFE)-( tx_RH_FOOT * sin_q_RH_HAA);
    ...
    (*this)(2,5) = (((- tx_RH_KFE * sin_q_RH_HAA)+(((- ty_RH_HFE * cos_q_RH_HAA)- ty_RH_HAA) * cos_q_RH_HFE)+( tx_RH_HAA * sin_q_RH_HAA * sin_q_RH_HFE)) * sin_q_RH_KFE)+(((((- ty_RH_HFE * cos_q_RH_HAA)- ty_RH_HAA) * sin_q_RH_HFE)-( tx_RH_HAA * sin_q_RH_HAA * cos_q_RH_HFE)) * cos_q_RH_KFE);
    (*this)(3,3) = (cos_q_RH_HFE * cos_q_RH_KFE)-(sin_q_RH_HFE * sin_q_RH_KFE);
    (*this)(3,5) = (cos_q_RH_HFE * sin_q_RH_KFE)+(sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(4,3) = (sin_q_RH_HAA * cos_q_RH_HFE * sin_q_RH_KFE)+(sin_q_RH_HAA * sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(4,4) = cos_q_RH_HAA;
...
const ForceTransforms::Type_fr_base_X_fr_LF_KFE& ForceTransforms::Type_fr_base_X_fr_LF_KFE::update(const state_t& q)
{
    ...
    (*this)(0,0) = -sin_q_LF_HFE;
    (*this)(0,1) = -cos_q_LF_HFE;
    (*this)(0,3) = ((- ty_LF_HAA * cos_q_LF_HAA)- ty_LF_HFE) * cos_q_LF_HFE;
    (*this)(0,4) = (( ty_LF_HAA * cos_q_LF_HAA)+ ty_LF_HFE) * sin_q_LF_HFE;
    (*this)(0,5) = ( tx_LF_KFE * cos_q_LF_HFE)+( ty_LF_HAA * sin_q_LF_HAA);
    (*this)(1,0) = sin_q_LF_HAA * cos_q_LF_HFE;
    (*this)(1,1) = -sin_q_LF_HAA * sin_q_LF_HFE;
    (*this)(1,2) = cos_q_LF_HAA;
    (*this)(1,3) = ( tx_LF_HAA * cos_q_LF_HAA * cos_q_LF_HFE)-( ty_LF_HFE * sin_q_LF_HAA * sin_q_LF_HFE);
    (*this)(1,4) = (- tx_LF_HAA * cos_q_LF_HAA * sin_q_LF_HFE)-( ty_LF_HFE * sin_q_LF_HAA * cos_q_LF_HFE)+( tx_LF_KFE * cos_q_LF_HAA);
    (*this)(1,5) = ( tx_LF_KFE * sin_q_LF_HAA * sin_q_LF_HFE)-( tx_LF_HAA * sin_q_LF_HAA);
    (*this)(2,0) = -cos_q_LF_HAA * cos_q_LF_HFE;
    (*this)(2,1) = cos_q_LF_HAA * sin_q_LF_HFE;
    (*this)(2,2) = sin_q_LF_HAA;
    (*this)(2,3) = (( ty_LF_HAA+( ty_LF_HFE * cos_q_LF_HAA)) * sin_q_LF_HFE)+( tx_LF_HAA * sin_q_LF_HAA * cos_q_LF_HFE);
    (*this)(2,4) = (- tx_LF_HAA * sin_q_LF_HAA * sin_q_LF_HFE)+(( ty_LF_HAA+( ty_LF_HFE * cos_q_LF_HAA)) * cos_q_LF_HFE)+( tx_LF_KFE * sin_q_LF_HAA);
...
const ForceTransforms::Type_fr_base_X_fr_RF_KFE& ForceTransforms::Type_fr_base_X_fr_RF_KFE::update(const state_t& q)
{
    ...
    (*this)(0,0) = -sin_q_RF_HFE;
    (*this)(0,1) = -cos_q_RF_HFE;
    (*this)(0,3) = ((- ty_RF_HAA * cos_q_RF_HAA)- ty_RF_HFE) * cos_q_RF_HFE;
    (*this)(0,4) = (( ty_RF_HAA * cos_q_RF_HAA)+ ty_RF_HFE) * sin_q_RF_HFE;
    (*this)(0,5) = ( tx_RF_KFE * cos_q_RF_HFE)+( ty_RF_HAA * sin_q_RF_HAA);
    (*this)(1,0) = sin_q_RF_HAA * cos_q_RF_HFE;
    (*this)(1,1) = -sin_q_RF_HAA * sin_q_RF_HFE;
    (*this)(1,2) = cos_q_RF_HAA;
    (*this)(1,3) = ( tx_RF_HAA * cos_q_RF_HAA * cos_q_RF_HFE)-( ty_RF_HFE * sin_q_RF_HAA * sin_q_RF_HFE);
    (*this)(1,4) = (- tx_RF_HAA * cos_q_RF_HAA * sin_q_RF_HFE)-( ty_RF_HFE * sin_q_RF_HAA * cos_q_RF_HFE)+( tx_RF_KFE * cos_q_RF_HAA);
    (*this)(1,5) = ( tx_RF_KFE * sin_q_RF_HAA * sin_q_RF_HFE)-( tx_RF_HAA * sin_q_RF_HAA);
    (*this)(2,0) = -cos_q_RF_HAA * cos_q_RF_HFE;
    (*this)(2,1) = cos_q_RF_HAA * sin_q_RF_HFE;
    (*this)(2,2) = sin_q_RF_HAA;
    (*this)(2,3) = (( ty_RF_HAA+( ty_RF_HFE * cos_q_RF_HAA)) * sin_q_RF_HFE)+( tx_RF_HAA * sin_q_RF_HAA * cos_q_RF_HFE);
    (*this)(2,4) = (- tx_RF_HAA * sin_q_RF_HAA * sin_q_RF_HFE)+(( ty_RF_HAA+( ty_RF_HFE * cos_q_RF_HAA)) * cos_q_RF_HFE)+( tx_RF_KFE * sin_q_RF_HAA);
...
const ForceTransforms::Type_fr_base_X_fr_LH_KFE& ForceTransforms::Type_fr_base_X_fr_LH_KFE::update(const state_t& q)
{
    ...
    (*this)(0,0) = -sin_q_LH_HFE;
    (*this)(0,1) = -cos_q_LH_HFE;
    (*this)(0,3) = ((- ty_LH_HAA * cos_q_LH_HAA)- ty_LH_HFE) * cos_q_LH_HFE;
    (*this)(0,4) = (( ty_LH_HAA * cos_q_LH_HAA)+ ty_LH_HFE) * sin_q_LH_HFE;
    (*this)(0,5) = ( tx_LH_KFE * cos_q_LH_HFE)+( ty_LH_HAA * sin_q_LH_HAA);
    (*this)(1,0) = sin_q_LH_HAA * cos_q_LH_HFE;
    (*this)(1,1) = -sin_q_LH_HAA * sin_q_LH_HFE;
    (*this)(1,2) = cos_q_LH_HAA;
    (*this)(1,3) = ( tx_LH_HAA * cos_q_LH_HAA * cos_q_LH_HFE)-( ty_LH_HFE * sin_q_LH_HAA * sin_q_LH_HFE);
    (*this)(1,4) = (- tx_LH_HAA * cos_q_LH_HAA * sin_q_LH_HFE)-( ty_LH_HFE * sin_q_LH_HAA * cos_q_LH_HFE)+( tx_LH_KFE * cos_q_LH_HAA);
    (*this)(1,5) = ( tx_LH_KFE * sin_q_LH_HAA * sin_q_LH_HFE)-( tx_LH_HAA * sin_q_LH_HAA);
    (*this)(2,0) = -cos_q_LH_HAA * cos_q_LH_HFE;
    (*this)(2,1) = cos_q_LH_HAA * sin_q_LH_HFE;
    (*this)(2,2) = sin_q_LH_HAA;
    (*this)(2,3) = (( ty_LH_HAA+( ty_LH_HFE * cos_q_LH_HAA)) * sin_q_LH_HFE)+( tx_LH_HAA * sin_q_LH_HAA * cos_q_LH_HFE);
    (*this)(2,4) = (- tx_LH_HAA * sin_q_LH_HAA * sin_q_LH_HFE)+(( ty_LH_HAA+( ty_LH_HFE * cos_q_LH_HAA)) * cos_q_LH_HFE)+( tx_LH_KFE * sin_q_LH_HAA);
...
const ForceTransforms::Type_fr_base_X_fr_RH_KFE& ForceTransforms::Type_fr_base_X_fr_RH_KFE::update(const state_t& q)
{
    ...
    (*this)(0,0) = -sin_q_RH_HFE;
    (*this)(0,1) = -cos_q_RH_HFE;
    (*this)(0,3) = ((- ty_RH_HAA * cos_q_RH_HAA)- ty_RH_HFE) * cos_q_RH_HFE;
    (*this)(0,4) = (( ty_RH_HAA * cos_q_RH_HAA)+ ty_RH_HFE) * sin_q_RH_HFE;
    (*this)(0,5) = ( tx_RH_KFE * cos_q_RH_HFE)+( ty_RH_HAA * sin_q_RH_HAA);
    (*this)(1,0) = sin_q_RH_HAA * cos_q_RH_HFE;
    (*this)(1,1) = -sin_q_RH_HAA * sin_q_RH_HFE;
    (*this)(1,2) = cos_q_RH_HAA;
    (*this)(1,3) = ( tx_RH_HAA * cos_q_RH_HAA * cos_q_RH_HFE)-( ty_RH_HFE * sin_q_RH_HAA * sin_q_RH_HFE);
    (*this)(1,4) = (- tx_RH_HAA * cos_q_RH_HAA * sin_q_RH_HFE)-( ty_RH_HFE * sin_q_RH_HAA * cos_q_RH_HFE)+( tx_RH_KFE * cos_q_RH_HAA);
    (*this)(1,5) = ( tx_RH_KFE * sin_q_RH_HAA * sin_q_RH_HFE)-( tx_RH_HAA * sin_q_RH_HAA);
    (*this)(2,0) = -cos_q_RH_HAA * cos_q_RH_HFE;
    (*this)(2,1) = cos_q_RH_HAA * sin_q_RH_HFE;
    (*this)(2,2) = sin_q_RH_HAA;
    (*this)(2,3) = (( ty_RH_HAA+( ty_RH_HFE * cos_q_RH_HAA)) * sin_q_RH_HFE)+( tx_RH_HAA * sin_q_RH_HAA * cos_q_RH_HFE);
    (*this)(2,4) = (- tx_RH_HAA * sin_q_RH_HAA * sin_q_RH_HFE)+(( ty_RH_HAA+( ty_RH_HFE * cos_q_RH_HAA)) * cos_q_RH_HFE)+( tx_RH_KFE * sin_q_RH_HAA);
...
const HomogeneousTransforms::Type_fr_base_X_LF_FOOT& HomogeneousTransforms::Type_fr_base_X_LF_FOOT::update(const state_t& q)
{
    ...
    (*this)(1,1) = cos_q_LF_HAA;
    (*this)(1,2) = (sin_q_LF_HAA * sin_q_LF_HFE * sin_q_LF_KFE)-(sin_q_LF_HAA * cos_q_LF_HFE * cos_q_LF_KFE);
    (*this)(1,3) = (- tx_LF_FOOT * sin_q_LF_HAA * sin_q_LF_HFE * sin_q_LF_KFE)+( tx_LF_FOOT * sin_q_LF_HAA * cos_q_LF_HFE * cos_q_LF_KFE)+( tx_LF_KFE * sin_q_LF_HAA * cos_q_LF_HFE)+( ty_LF_HFE * cos_q_LF_HAA)+ ty_LF_HAA;
    (*this)(2,0) = (-cos_q_LF_HAA * cos_q_LF_HFE * sin_q_LF_KFE)-(cos_q_LF_HAA * sin_q_LF_HFE * cos_q_LF_KFE);
    (*this)(2,1) = sin_q_LF_HAA;
    (*this)(2,2) = (cos_q_LF_HAA * cos_q_LF_HFE * cos_q_LF_KFE)-(cos_q_LF_HAA * sin_q_LF_HFE * sin_q_LF_KFE);
    (*this)(2,3) = ( tx_LF_FOOT * cos_q_LF_HAA * sin_q_LF_HFE * sin_q_LF_KFE)-( tx_LF_FOOT * cos_q_LF_HAA * cos_q_LF_HFE * cos_q_LF_KFE)-( tx_LF_KFE * cos_q_LF_HAA * cos_q_LF_HFE)+( ty_LF_HFE * sin_q_LF_HAA);
    return *this;
}
...
const HomogeneousTransforms::Type_fr_base_X_RF_FOOT& HomogeneousTransforms::Type_fr_base_X_RF_FOOT::update(const state_t& q)
{
    ...
    (*this)(1,1) = cos_q_RF_HAA;
    (*this)(1,2) = (sin_q_RF_HAA * sin_q_RF_HFE * sin_q_RF_KFE)-(sin_q_RF_HAA * cos_q_RF_HFE * cos_q_RF_KFE);
    (*this)(1,3) = (- tx_RF_FOOT * sin_q_RF_HAA * sin_q_RF_HFE * sin_q_RF_KFE)+( tx_RF_FOOT * sin_q_RF_HAA * cos_q_RF_HFE * cos_q_RF_KFE)+( tx_RF_KFE * sin_q_RF_HAA * cos_q_RF_HFE)+( ty_RF_HFE * cos_q_RF_HAA)+ ty_RF_HAA;
    (*this)(2,0) = (-cos_q_RF_HAA * cos_q_RF_HFE * sin_q_RF_KFE)-(cos_q_RF_HAA * sin_q_RF_HFE * cos_q_RF_KFE);
    (*this)(2,1) = sin_q_RF_HAA;
    (*this)(2,2) = (cos_q_RF_HAA * cos_q_RF_HFE * cos_q_RF_KFE)-(cos_q_RF_HAA * sin_q_RF_HFE * sin_q_RF_KFE);
    (*this)(2,3) = ( tx_RF_FOOT * cos_q_RF_HAA * sin_q_RF_HFE * sin_q_RF_KFE)-( tx_RF_FOOT * cos_q_RF_HAA * cos_q_RF_HFE * cos_q_RF_KFE)-( tx_RF_KFE * cos_q_RF_HAA * cos_q_RF_HFE)+( ty_RF_HFE * sin_q_RF_HAA);
    return *this;
}
...
const HomogeneousTransforms::Type_fr_base_X_LH_FOOT& HomogeneousTransforms::Type_fr_base_X_LH_FOOT::update(const state_t& q)
{
    ...
    (*this)(1,1) = cos_q_LH_HAA;
    (*this)(1,2) = (sin_q_LH_HAA * sin_q_LH_HFE * sin_q_LH_KFE)-(sin_q_LH_HAA * cos_q_LH_HFE * cos_q_LH_KFE);
    (*this)(1,3) = (- tx_LH_FOOT * sin_q_LH_HAA * sin_q_LH_HFE * sin_q_LH_KFE)+( tx_LH_FOOT * sin_q_LH_HAA * cos_q_LH_HFE * cos_q_LH_KFE)+( tx_LH_KFE * sin_q_LH_HAA * cos_q_LH_HFE)+( ty_LH_HFE * cos_q_LH_HAA)+ ty_LH_HAA;
    (*this)(2,0) = (-cos_q_LH_HAA * cos_q_LH_HFE * sin_q_LH_KFE)-(cos_q_LH_HAA * sin_q_LH_HFE * cos_q_LH_KFE);
    (*this)(2,1) = sin_q_LH_HAA;
    (*this)(2,2) = (cos_q_LH_HAA * cos_q_LH_HFE * cos_q_LH_KFE)-(cos_q_LH_HAA * sin_q_LH_HFE * sin_q_LH_KFE);
    (*this)(2,3) = ( tx_LH_FOOT * cos_q_LH_HAA * sin_q_LH_HFE * sin_q_LH_KFE)-( tx_LH_FOOT * cos_q_LH_HAA * cos_q_LH_HFE * cos_q_LH_KFE)-( tx_LH_KFE * cos_q_LH_HAA * cos_q_LH_HFE)+( ty_LH_HFE * sin_q_LH_HAA);
    return *this;
}
...
const HomogeneousTransforms::Type_fr_base_X_RH_FOOT& HomogeneousTransforms::Type_fr_base_X_RH_FOOT::update(const state_t& q)
{
    ...
    (*this)(1,1) = cos_q_RH_HAA;
    (*this)(1,2) = (sin_q_RH_HAA * sin_q_RH_HFE * sin_q_RH_KFE)-(sin_q_RH_HAA * cos_q_RH_HFE * cos_q_RH_KFE);
    (*this)(1,3) = (- tx_RH_FOOT * sin_q_RH_HAA * sin_q_RH_HFE * sin_q_RH_KFE)+( tx_RH_FOOT * sin_q_RH_HAA * cos_q_RH_HFE * cos_q_RH_KFE)+( tx_RH_KFE * sin_q_RH_HAA * cos_q_RH_HFE)+( ty_RH_HFE * cos_q_RH_HAA)+ ty_RH_HAA;
    (*this)(2,0) = (-cos_q_RH_HAA * cos_q_RH_HFE * sin_q_RH_KFE)-(cos_q_RH_HAA * sin_q_RH_HFE * cos_q_RH_KFE);
    (*this)(2,1) = sin_q_RH_HAA;
    (*this)(2,2) = (cos_q_RH_HAA * cos_q_RH_HFE * cos_q_RH_KFE)-(cos_q_RH_HAA * sin_q_RH_HFE * sin_q_RH_KFE);
    (*this)(2,3) = ( tx_RH_FOOT * cos_q_RH_HAA * sin_q_RH_HFE * sin_q_RH_KFE)-( tx_RH_FOOT * cos_q_RH_HAA * cos_q_RH_HFE * cos_q_RH_KFE)-( tx_RH_KFE * cos_q_RH_HAA * cos_q_RH_HFE)+( ty_RH_HFE * sin_q_RH_HAA);
    return *this;
}
...
const HomogeneousTransforms::Type_fr_base_X_fr_LF_KFE& HomogeneousTransforms::Type_fr_base_X_fr_LF_KFE::update(const state_t& q)
{
    ...
    (*this)(1,1) = -sin_q_LF_HAA * sin_q_LF_HFE;
    (*this)(1,2) = cos_q_LF_HAA;
    (*this)(1,3) = ( tx_LF_KFE * sin_q_LF_HAA * cos_q_LF_HFE)+( ty_LF_HFE * cos_q_LF_HAA)+ ty_LF_HAA;
    (*this)(2,0) = -cos_q_LF_HAA * cos_q_LF_HFE;
    (*this)(2,1) = cos_q_LF_HAA * sin_q_LF_HFE;
    (*this)(2,2) = sin_q_LF_HAA;
    (*this)(2,3) = ( ty_LF_HFE * sin_q_LF_HAA)-( tx_LF_KFE * cos_q_LF_HAA * cos_q_LF_HFE);
    return *this;
}
...
const HomogeneousTransforms::Type_fr_base_X_fr_RF_KFE& HomogeneousTransforms::Type_fr_base_X_fr_RF_KFE::update(const state_t& q)
{
    ...
    (*this)(1,1) = -sin_q_RF_HAA * sin_q_RF_HFE;
    (*this)(1,2) = cos_q_RF_HAA;
    (*this)(1,3) = ( tx_RF_KFE * sin_q_RF_HAA * cos_q_RF_HFE)+( ty_RF_HFE * cos_q_RF_HAA)+ ty_RF_HAA;
    (*this)(2,0) = -cos_q_RF_HAA * cos_q_RF_HFE;
    (*this)(2,1) = cos_q_RF_HAA * sin_q_RF_HFE;
    (*this)(2,2) = sin_q_RF_HAA;
    (*this)(2,3) = ( ty_RF_HFE * sin_q_RF_HAA)-( tx_RF_KFE * cos_q_RF_HAA * cos_q_RF_HFE);
    return *this;
}
...
const HomogeneousTransforms::Type_fr_base_X_fr_LH_KFE& HomogeneousTransforms::Type_fr_base_X_fr_LH_KFE::update(const state_t& q)
{
    ...
    (*this)(1,1) = -sin_q_LH_HAA * sin_q_LH_HFE;
    (*this)(1,2) = cos_q_LH_HAA;
    (*this)(1,3) = ( tx_LH_KFE * sin_q_LH_HAA * cos_q_LH_HFE)+( ty_LH_HFE * cos_q_LH_HAA)+ ty_LH_HAA;
    (*this)(2,0) = -cos_q_LH_HAA * cos_q_LH_HFE;
    (*this)(2,1) = cos_q_LH_HAA * sin_q_LH_HFE;
    (*this)(2,2) = sin_q_LH_HAA;
    (*this)(2,3) = ( ty_LH_HFE * sin_q_LH_HAA)-( tx_LH_KFE * cos_q_LH_HAA * cos_q_LH_HFE);
    return *this;
}
...
const HomogeneousTransforms::Type_fr_base_X_fr_RH_KFE& HomogeneousTransforms::Type_fr_base_X_fr_RH_KFE::update(const state_t& q)
{
    ...
    (*this)(1,1) = -sin_q_RH_HAA * sin_q_RH_HFE;
    (*this)(1,2) = cos_q_RH_HAA;
    (*this)(1,3) = ( tx_RH_KFE * sin_q_RH_HAA * cos_q_RH_HFE)+( ty_RH_HFE * cos_q_RH_HAA)+ ty_RH_HAA;
    (*this)(2,0) = -cos_q_RH_HAA * cos_q_RH_HFE;
    (*this)(2,1) = cos_q_RH_HAA * sin_q_RH_HFE;
    (*this)(2,2) = sin_q_RH_HAA;
    (*this)(2,3) = ( ty_RH_HFE * sin_q_RH_HAA)-( tx_RH_KFE * cos_q_RH_HAA * cos_q_RH_HFE);
    return *this;
}
