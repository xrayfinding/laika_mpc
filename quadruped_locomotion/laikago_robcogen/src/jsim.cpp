...
laikago::rcg::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const laikago::rcg::JSIM& laikago::rcg::JSIM::update(const JointState& state) {
...
void laikago::rcg::JSIM::computeL() {
    L = this -> triangularView<Eigen::Lower>();
    // Joint LH_KFE, index 11 :
...
void laikago::rcg::JSIM::computeLInverse() {
