...
{
    ROS_WARN("StateEstimateController constructed!!!!!!!!!!!");
...
//    hardware_interface::RobotStateHandle handle;
//    robot_state_handle = handle;
...
{
    ROS_WARN_ONCE("State Estimate Update Once!!!!!!!!");
    ...
    //MXR::NOTE get feet_contact_force from robot state handle(just for laikago)
