...
namespace balance_controller{
    class LaikagoJointController: public controller_interface::Controller<hardware_interface::RobotStateInterface>
    {
        private:

            //hardware_interface::EffortJointInterface joint_test;
        ...
        public:
            ...
            hardware_interface::RobotStateHandle joint;
            LaikagoJointController();
            ~LaikagoJointController();
            virtual bool init(hardware_interface::RobotStateInterface *robot, ros::NodeHandle &n);
