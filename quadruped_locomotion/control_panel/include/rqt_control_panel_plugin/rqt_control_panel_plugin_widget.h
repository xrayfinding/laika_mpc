...
private slots:
  ...
  void on_trotButton_3_clicked();

  void on_stopBotton_clicked();

  void on_stopBotton_3_clicked();
  ...
  void on_setVelocityBotton_3_clicked();
...
private:
  ...
  ros::ServiceClient switchControllerClient_,my_switchControllerClient_;
