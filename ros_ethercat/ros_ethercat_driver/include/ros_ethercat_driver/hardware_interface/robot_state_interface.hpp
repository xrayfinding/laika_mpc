 ...
 * TODO: Document more!
 */
class RobotStateHandle : public JointHandle     //the class of robot_handle
{
public:
  struct Data
  {
...
//    double* lh_leg_phase;       ///< A pointer store the phase(0~1) of leg [sw,st]
  ...
  RobotStateHandle(const Data& data = Data())       //de_constructor
    : name_(data.name),
  ...
  RobotStateHandle(      //copy_constructor
...
public:
   ...
   */
  hardware_interface::JointCommandInterface joint_effort_interfaces_;    //control level = effort
};
