...
int main(int argc, char *argv[])
{
    ...
    ros::init(argc, argv, "position_reset");
    ros::NodeHandle n;
    ...
    while (ros::ok()){
        ...
        //std::cout<<"get the joint position!"<<std::endl;
...
//            }
            ...
            SendLowROS.motorCmd[FR_1].position = 0.67;
            ...
            SendLowROS.motorCmd[FR_2].position =  -1.3;
            ...
            SendLowROS.motorCmd[FL_0].position = 0.0;
            ...
            SendLowROS.motorCmd[FL_1].position = 0.67;
            ...
            SendLowROS.motorCmd[FL_2].position =  -1.3;
            ...
            SendLowROS.motorCmd[RR_0].position = 0.0;
            ...
            SendLowROS.motorCmd[RR_1].position = 0.67;
            ...
            SendLowROS.motorCmd[RR_2].position =  -1.3;
            ...
            SendLowROS.motorCmd[RL_0].position = 0.0;
            ...
            SendLowROS.motorCmd[RL_1].position = 0.67;
            ...
            SendLowROS.motorCmd[RL_2].position =  -1.3;
